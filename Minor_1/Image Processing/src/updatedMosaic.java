...
public class updatedMosaic
{


private static String targetImagePath = "H:/hp/eclipse/programs/Image Processing/src/Input Images/Target.jpg";


private static String listFolderPath = "H:/hp/eclipse/programs/Image Processing/src/listImages";



private static int xScale = 10;
private static int yScale = 10;
static BufferedImage outputMosaic = null;
...
public static void main(String[] args)
{
	...
	//Importing image
		...
		int[][] matchArray = matchImageWithBlocks(blockArray, listImageRGBs);
		 ...
		 File resultFile = new File("H:/hp/eclipse/programs/Image Processing/src/Output Images/enhancedOutputMosaic.png");
			ImageIO.write(outputMosaic, "png", resultFile);		
...
private static int[][][] mainImageBlockRGB(BufferedImage imageSource) throws IOException//for getting the 
{
...
private static BufferedImage[] getListImages(String listFolderPath) throws IOException {
...
private static int[][] listImagesRGB(BufferedImage[] listImages) throws IOException
{
...
private static int[][] matchImageWithBlocks(int[][][] blockArray, int[][] listImageRGBs)
{
...
private static BufferedImage createResult(BufferedImage mainImage, BufferedImage[] listImages, int[][] matchArray) throws IOException
{
